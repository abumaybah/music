            ...
            <div class="bg-white rounded border border-gray-200 relative flex flex-col">
                ...
                <div class="p-6">
                    ...
                    <vee-form :validation-schema="schema" @submit="addComment" v-if="userLoggedIn">
                        ...
                        <button type="submit" class="py-1.5 px-3 rounded text-white bg-green-600" :disabled="comment_in_submission">Submit</button>
                    </vee-form>
                    ...
                    <ErrorMessage class="text-red-600" name="select" />
                </div>
            </div>
        </section>
